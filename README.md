...
**Evaluation:** question generation from index chunks via Claude, retrieval metrics (Precision@K / Recall@K / MRR), and answer faithfulness scoring via RAGAS or Claude-as-judge fallback.
